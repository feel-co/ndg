ndg/tests/formatter/header_extraction.rs
```
use comrak::{Arena, ComrakOptions, nodes::{AstNode, NodeValue, NodeHeading}, parse_document};
use ndg::formatter::markdown::{extract_headers, Header};

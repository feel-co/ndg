...
/// Process raw type string preserving escape sequences but formatting quotes and newlines properly
...
fn process_inline_markdown(text: &str) -> String {
    ...
    // Escape any troff special characters and commands, but not existing troff formatting

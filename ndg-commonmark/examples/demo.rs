...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let demo_content = fs::read_to_string("demo/test-all-features.md")
        .expect("Failed to read demo file. Make sure you're running from the ndg root directory.");
    ...
    // Test tables
    let table_test = "| Header 1 | Header 2 |\n|----------|----------|\n| Cell 1   | Cell 2   |";
...
{}
    ...
    println!("Styled demo output available at: demo/output/demo-with-styles.html");
